            ...
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    <div class="card-header bg-primary-subtle ">
                        <h3 class="card-title fw-bold">Add Categories</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <div class="row">
                            <form id="myForm" action="{{route('admin#storeCategory')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="status"
                                                 id="defaultCheck1" @if(old('name')) {{'ckecked'}} @endif>
